...
<!-- BEGIN BODY -->
<body style="margin-bottom:10px; min-height:750px;;min-width: 1004px;">
...
<div class="row">
 ...
 <form class="form-horizontal" role="form"   method="post" action="<?php echo U('Public/dologin/');?>">
								<div class="form-group">
									
									<div class="col-md-12">
										<div class="input-icon">
											<i class="fa fa-user"></i>
											<input type="text" name="username" placeholder="" id="inputEmail12" class="form-control" required autofocus>
...
技术支持：<a href="http://www.wangminwei.com">民伟网络</a>
