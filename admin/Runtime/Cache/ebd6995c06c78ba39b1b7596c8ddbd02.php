	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
             <li class="active"><a href="<?php echo U('Foodcat/index/');?>" ><b>商品分类</b></a></li>
		  ...
		  <p></P>
           ...
           <div class="row"> 
             <div class="col-lg-2 col-md-2 col-xs-2" ><a class="btn blue" href="<?php echo U('Foodcat/add/');?>"> <i class="fa fa-plus"></i>增加分类</a></div>
			 <div class="col-lg-6 col-md-6 col-xs-6" ><span class="help-block">商品分类 如：小炒，酒水，中餐，川菜</span></div>
		  ...
		  <p></P>
			    ...
			    <table class="table table-striped table-bordered table-hover">
									...
									<tbody>
									<?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = $foodcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($vo["fcid"]); ?></td>
											<td><?php echo ($vo["fcname"]); ?></td>
											<td><?php echo ($vo["fcsort"]); ?></td>
											<td>
											
											<a  href="<?php echo U('Foodcat/edit/','id='.$vo['fcid']);?>" ><i class="fa fa-edit"></i> 修改</a>
											    <a  href="<?php echo U('Foodcat/del/','id='.$vo['fcid']);?>"><i class="fa fa-trash-o"></i> 删除</a>
