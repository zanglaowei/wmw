	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
			...
			<li class="active"><a href="#" ><b>商家修改</b></a></li>
...
<form class="form-horizontal"role="form" enctype="multipart/form-data" action="<?php echo U('Shop/editsave/');?>" method="post">

  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">商家名称</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="sname" value="<?php echo ($item["sname"]); ?>">
	 <input type="hidden"  name="sid" value="<?php echo ($item["sid"]); ?>">
    </div>
	<div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i>商家名称，如江泉大酒店</span>
 </div>
  </div>
 <div class="form-group">
    <label for="inputEmail5" class="col-sm-2 control-label">口味分类</label>
    <div class="col-sm-3">
     <select class="form-control" name="fcid">
	
													<?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = $foodcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['fcid']) == $item['fcid']): ?><option value="<?php echo ($vo["fcid"]); ?>" selected="selected"><?php echo ($vo["fcname"]); ?></option>
													  <?php else: ?>
													  <option value="<?php echo ($vo["fcid"]); ?>" ><?php echo ($vo["fcname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>	
																</select>
...
<span class="help-block"><i class="fa fa-exclamation"></i>请输入选择分类</span></span>
  ...
  <div class="form-group">
    <label for="inputEmail8" class="col-sm-2 control-label">logo</label>
    <div class="col-sm-4">
      
	 <input type="file" name="spic" id="exampleInputFile">
...
<div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="sprice" value="<?php echo ($item["sprice"]); ?>">
	 
    </div>
	<div class="col-sm-8">
<span class="help-block"><i class="fa fa-exclamation"></i>请输入消费价格</span>
 </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="semail" value="<?php echo ($item["semail"]); ?>">
	 
    </div>
	<div class="col-sm-8">
<span class="help-block"><i class="fa fa-exclamation"></i>用来接受订单，例如：admin@admin.com</span>
 </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">订餐电话</label>
    <div class="col-sm-2">
      <input type="text" class="form-control" name="sphone" value="<?php echo ($item["sphone"]); ?>">
	 
    </div>
	<div class="col-sm-8">
<span class="help-block"><i class="fa fa-exclamation"></i>请输入电话或者手机号</span>
 </div>
  </div>

    <div class="form-group">
    <label for="inputEmail11" class="col-sm-2 control-label">简介</label>
    <div class="col-sm-6">



<textarea class="form-control" name="scontent" rows="3"><?php echo ($item["scontent"]); ?></textarea>
...
<span class="help-block"></span>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="ssort" value="<?php echo ($item["ssort"]); ?>">
