	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
			 ...
			 <li class="active"><a href="<?php echo U('Shop/add/');?>" ><b>商家增加</b></a></li>
              </ul>
		  <p></P>
...
<form class="form-horizontal"role="form" enctype="multipart/form-data" action="<?php echo U('Shop/addsave/');?>" method="post">

  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">商家名称</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="sname" value="">
	 
    </div>
	<div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i>店铺名称，例如：江泉大酒店</span>
 </div>
  </div>
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail8" class="col-sm-2 control-label">商家logo</label>
    <div class="col-sm-4">
...
<div class="form-group">
<label for="inputEmail8" class="col-sm-2 control-label">营业时间</label>
    <div class="col-sm-2">
...
<option value="00:00">00:00</option>   
        ...
        <div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i> 营业时间</span>
 </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="sprice" value="">
	 
    </div>
	<div class="col-sm-8">
<span class="help-block"><i class="fa fa-exclamation"></i>请输入人均消费价格，例如：50</span>
 </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">电子邮箱</label>
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="semail" value="">
...
<span class="help-block"><i class="fa fa-exclamation"></i>用来接受订单，例如：admin@admin.com</span>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" name="sphone" value="">
...
<span class="help-block"><i class="fa fa-exclamation"></i>请输入电话或者手机号</span>
    ...
    <div class="col-sm-6">
		...
		<textarea class="form-control" name="scontent" rows="3"></textarea>
...
<span class="help-block"></span>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="ssort" value="0">
    </div>
	<div class="col-sm-6">
