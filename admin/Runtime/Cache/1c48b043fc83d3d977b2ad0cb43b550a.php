	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
             <li class="active"><a href="<?php echo U('Shop/index/');?>" ><b>商家维护</b></a></li>
			 <li><a href="<?php echo U('Shop/add/');?>" ><b>商家增加</b></a></li>

          </ul>
		  <p></P>
           <div class="row"> 
             <div class="col-lg-2 col-md-2 col-xs-2" ><a class="btn blue" href="<?php echo U('Shop/add/');?>"> <i class="fa fa-plus"></i>增加商家</a></div>
		  ...
		  <p></P>
			      ...
			      <table class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($shoplist)): $i = 0; $__LIST__ = $shoplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($vo["semail"]); ?></td>
											<td><?php echo ($vo["sphone"]); ?></td>
											<td><?php echo ($vo["ssort"]); ?></td>
											<td>
											    <a href="<?php echo U('Shop/edit/','id='.$vo['sid']);?>"><i class="fa fa-edit"></i> 修改</a>
												<a href="<?php echo U('Shop/del/','id='.$vo['sid']);?>"><i class="fa fa-trash-o"></i> 删除</a>
											</td>
