...
<?php if(is_array($articlelist)): $i = 0; $__LIST__ = $articlelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Article/l/','id='.$vo['acid']);?>" class="list-group-item list-border">
  ...
  <ul class="nav nav-tabs " >
		  ...
		  <p></P>
	<ol class="ocss">	  
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><p><span class="glyphicon glyphicon-tag"></span><a href="<?php echo U('Article/s/','id='.$vo['aid']);?>" title="<?php echo ($vo["atitle"]); ?>"><?php echo ($vo["atitle"]); ?></a></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ol>
