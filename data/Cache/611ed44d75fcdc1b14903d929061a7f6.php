...
<div class="container main">
    ...
    <div class="row area">
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=1">
      ...
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=2" >
      ...
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=3" >
      ...
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=4" >
      ...
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=5" >
      ...
      <div class="col-lg-2 col-md-2 col-xs-6">
        <a href="index.php?m=shop&a=farealist&id=6" >
